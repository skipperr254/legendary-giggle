        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-700">Personalized style recommendations</span>
            </div>
            <div className="flex items-center space-x-3">
          ...
          <div className="text-center">
            <p className="text-gray-600 mb-6">
              Dive into our interactive experience as you define your own interior design preferences 
              and get personalized recommendations for your space.
            </p>
            <div className="mb-6">
              <Label htmlFor="firstName" className="text-left block mb-2 text-gray-700">
                First Name
              </Label>
              <Input
                id="firstName"
